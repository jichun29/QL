...
//来源https://github.com/smallfawn/QLScriptPublic
//let ruishuApi = 'https://cn-sz-yd-plustmp1.natfrp.cloud:53887'//自己建的api，稳定性不知道。需要稳定的可以自己搭
let ruishuApi = 'http://192.168.31.33:1257'//自己建的api，稳定性不知道。需要稳定的可以自己搭
        ...
        while (_0x3a35d0 < _0x5a04a9) {
            try {
                ...
                await new Promise(async _0x45b1d3 => {
                    ...
                    //     )
                    // })
                    let Cookie = await this.got.post(ruishuApi + "/get_cookies", {
                        body: JSON.stringify({ response: "", url: "" }),
